...
class DepositPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const summaryTotalTextStyle = TextStyle(
      color: Colors.black,
      fontSize: 14,
                ...
                child: Column(
                  ...
                  children: [
                    if (ctrl.currentUser == null ||
                        ctrl.currentUser?.monetaryZone == null)
                      PaymentZoneSwitch(
                        isAfricanZone: ctrl.isLocalZone,
                        onAfricanZoneTap: ctrl.switchZone,
                        onOtherZoneTap: ctrl.switchZone,
                      ),

                    Skeletonizer(
                      enabled: ctrl.selectableCurrencies.isEmpty ||
                      ...
                      child: Padding(
                        ...
                        child: SelectFormField(
                          ...
                          items: <Map<String, dynamic>>[
                            ...ctrl.selectableCurrencies.map(
                              (curr) => {
                                'value': curr.code,
                                'label': ctrl.currencyLabel(curr),
                              },
                            ),
                          ],
